...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str,  default="models/yolov8n-seg.onnx", help="Path to ONNX model")
    ...
    bash > 
    yolo export model=models/yolov8n-seg.pt imgsz=640 format=onnx opset=12 simplify
    '''
