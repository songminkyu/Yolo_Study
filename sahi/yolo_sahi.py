...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default="../models/yolov8n.pt", help="initial weights path")
    parser.add_argument("--source", type=str, default="../@sample/traffic 2.mp4", help="video file path")
    parser.add_argument("--view-img", action="store_true", help="show results")
    parser.add_argument("--save-img", action="store_true", help="save results")
    parser.add_argument("--exist-ok", action="store_true", help="existing project/name ok, do not increment")

    args = parser.parse_args()
    # Setting the flags programmatically
    args.view_img = True
    args.save_img = False
    args.exist_ok = False
